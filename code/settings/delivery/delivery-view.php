...
<style>
  ...
  .deliveryWrapper.opaque button.grayedOut{
    background:#333;
    border:1px solid #333;
  }

  .deliveryWrapper.opaque button.grayedOut:hover{
    background:#333;
    border:1px solid #333;
  }
  ...
  <div ng:show="selected == 1" class='delivery-tab-content'>
      <div class='controlWrapper largeMarginBottom' ng-class="{'error': deliveryForm.deliveryZone.$invalid && triedSubmit }">
        ...
        <input type='text' id='deliveryZone' name='deliveryZone' ng-model="venueSettings.deliveryZone" ng-maxlength=200 placeholder='<? echo _('eg. "5 miles" or "NW1, NW2..."')?>' ng-disabled="!venue.deliverFlag"/>      
      ...
      <div class='controlWrapper largeMarginBottom'>
        ...
        <input type='text' id='telephone' name='telephone' ng-model="venueSettings.deliveryPhone" placeholder='+44 (0) 12345678' ng-disabled="!venue.deliverFlag"/>        
      </div>
      <div class='controlWrapper inlineControl' ng-class="{'error': deliveryForm.minValueOrder.$invalid && triedSubmit }">
        ...
        <input class='inlineInput' placeholder="0.00" type='text' id='minValueOrder' name='minValueOrder' ng-model="venueSettings.deliveryOrderMin" ng-pattern="/^[0-9]+(\.[0-9]{1,2})?$/" ng-disabled="!venue.deliverFlag">      
      ...
      <div class='controlWrapper inlineControl' ng-class="{'error': deliveryForm.deliveryCharge.$invalid && triedSubmit }">
        ...
        <input class='inlineInput'  placeholder="0.00" type='text' id='deliveryCharge' name='deliveryCharge' ng-model="venueSettings.deliveryCharge" ng-pattern="/^[0-9]+(\.[0-9]{1,2})?$/" ng-disabled="!venue.deliverFlag"/>
      ...
      <div class='controlWrapper inlineControl' ng-class="{'error': deliveryForm.deliveryBelow.$invalid && triedSubmit }">
        ...
        <input class='inlineInput'  placeholder="0.00" type='text' id='deliveryChargeBelow' name='deliveryChargeBelow' ng-model="venueSettings.deliveryChargeBelow" ng-pattern="/^[0-9]+(\.[0-9]{1,2})?$/" ng-disabled="!venue.deliverFlag"/>
      ...
      <input class='inlineInput'  placeholder="20" type='text' id='deliveryLeadTime' name='deliveryLeadTime' ng-model="venueSettings.deliveryLeadTime" ng-pattern="/^[0-9]+$/" ng-disabled="!venue.deliverFlag"/>
      ...
      <input class='inlineInput'  placeholder="5" type='text' id='deliveryDiscount' name='deliveryDiscount' ng-model="venueSettings.deliveryDiscount" ng-pattern="/^(0?[0-9]?[0-9]|100)$/" ng-disabled="!venue.deliverFlag"/>
  ...
  <div ng:show="selected == 2" class='delivery-tab-content'>
      ...
      <div class='row messageRow' ng-repeat="message in messages.notify" >      
          <div class='messageCol-1' ng-class="{'error': validateMessage(message) }">
            <input class='' type='text' ng-change="validateActive(message)"  ng-model="message.content" placeholder='eg."{{getPlaceholder("notify",$index).content}}"' ng-required='validateMessage(message)' ng-disabled="!venue.deliverFlag"/>
          ...
          <div class='messageCol-2' ng-class="{'error': validateMessage(message)}">
              <input class='' type='text' ng-change="validateActive(message)" ng-model="message.name" placeholder='eg."{{getPlaceholder("notify",$index).name}}"' ng-required='validateMessage(message)' ng-disabled="!venue.deliverFlag"/>
          </div>
          <div class="messageCol-3 switch" ng-class="{'off': message.active==0, 'disabled':!validateActive(message)}" > 
          <input  value="0" type="radio" ng-model="message.active" ng-disabled="!validateActive(message) || !venue.deliverFlag" tabindex=-1>
            <label class="no"><?echo _("No")?></label>
          <input value="1" type="radio" ng-model="message.active" ng-disabled="!validateActive(message) || !venue.deliverFlag" tabindex=-1>
            <label class="yes"><?echo _("Yes")?></label>
            <span></span>
          </div>                
      </div>
  ...
  <div ng:show="selected == 3" class='delivery-tab-content'>
     <div class="row messageRow messageRowHeader">
      ...
      <div class='row messageRow' ng-repeat="message in messages.reject" >      
          ...
          <div class='messageCol-1' ng-class="{'error': validateMessage(message) }">
            <input class='' type='text' ng-change="validateActive(message)"  ng-model="message.content" placeholder='eg."{{getPlaceholder("reject",$index).content}}"' ng-required='validateMessage(message)' ng-disabled="!venue.deliverFlag"/>
          ...
          <div class='messageCol-2' ng-class="{'error': validateMessage(message)}">
              <input class='' type='text' ng-change="validateActive(message)" ng-model="message.name"    placeholder='eg."{{getPlaceholder("reject",$index).name}}"' ng-required='validateMessage(message)'ng-disabled="!venue.deliverFlag"/>
          </div>
          <div class="messageCol-3 switch" ng-class="{'off': message.active==0, 'disabled':!validateActive(message)}" > 
          <input  value="0" type="radio" ng-model="message.active" ng-disabled="!validateActive(message) || !venue.deliverFlag" tabindex=-1>
            <label class="no"><?echo _("No")?></label>
    ...
    <div>
      <button ng-show="!isPosting" id="deliverySave" ng-class="{'grayedOut':!venue.deliveryFlag}"  ng-disabled="!venue.deliverFlag" type="submit" ><?echo _("SAVE CHANGES");?></button>
