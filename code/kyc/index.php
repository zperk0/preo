          ...
          <form ng-submit="update()" class='navbar-form navbar-left columns large-5 small-12 nopadding' ng-if="showDateFilter">            
              <div class="row nomargin">              
                  ...
                  <div class="columns large-4 small-4 nopadding"> 
                    <input type="text" class="form-control input-search dropdown pdDropdown" datepicker end="end_date" ng-model="form.start_date" />
                  </div>
                  <div class='columns large-1 small-2 dateTo nopadding'>
                    <? echo _("to") ?>
                  </div>
                  <div class="columns large-4 small-4 nopadding"> 
                    <input type="text" class="form-control input-search dropdown pdDropdown" datepicker start="start_date" ng-model="form.end_date" />
                  </div>
