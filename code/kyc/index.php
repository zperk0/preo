...
<div ng-app="kyc" ng-controller='MenuCtrl' ng-init="showDateFilter = true" class='kycWrapper'>
  ...
  <header>
    <nav class="row withEvents" data-topbar role="navigation" id="navbar-menu">
          <ul>
            <li class="metrics" ng-class='{active:currentLocation==="dashboard"}' ng-click='setLocation("dashboard")'><span translate>Metrics</span></li>
            <li class="stock" ng-class='{active:currentLocation==="stock"}' ng-click='setLocation("stock")'><span translate>Stock</span></li>
            <li class="customers" ng-class='{active:currentLocation==="customers"}' ng-click='setLocation("customers")'><span translate>Customers</span></li>
            <li class="reports" ng-class='{active:currentLocation==="reports"}' ng-click='setLocation("reports")'><span translate>Reports</span></li>
            <li class="live-stream" ng-class='{active:currentLocation==="stream"}' ng-click='setLocation("stream")'><span translate>Live stream</span></li>
            <li class="events" ng-if="venue.eventFlag" ng-class='{active:currentLocation==="events"}' ng-click='setLocation("events")'><span translate>Events</span></li>
            <li class="orders" ng-if="!venue.eventFlag" ng-class='{active:currentLocation==="orders"}' ng-click='setLocation("orders")'><span translate>Orders</span></li>
          </ul>
    </nav>
  </header>
      ...
      <div class="row formContainer" >
              ...
              <div class="columns large-12 small-12 nopadding">
                  ...
                  <div class='columns large-9 small-10 nopadding'>
                   ...
                   <div class='columns large-3 small-2'>
                    <button type="submit" class="preodayButton small " translate>Refresh</button>
                   </div>
              </div>
            </div>
          </form>
          ...
          <form ng-submit="update()" class='navbar-form navbar-left columns large-5 small-12 nopadding' ng-if="showDateFilter">
              <div class="row nomargin">
                  ...
                  <div class='columns large-1 small-2 dateTo nopadding' translate>
                    to
                  </div>
                  <div class="columns large-4 small-4 nopadding">
                  ...
                  <div class="columns large-3 small-2 nopadding">
                    <button type="submit" class="preodayButton small pull-right" translate>Refresh</button>
                  </div>
              </div>
          </form>
  ...
  <script src="/code/kyc/js/charts/ordersPerChannel.js"></script>
