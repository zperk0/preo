var features = [
	...
	{
		id: 7,
		description: <? echo json_encode(_("Web Orders Plus comes with all the functionality of Web Orders but with the added benefit of being able to choose your own customised web address. A memorable web address can make it easier for customers to find you online and strengthens your brand.")) ?>,
		shortDescription: <? echo json_encode(_("Just like ‘Web orders’ but with a customised web address, chosen by you."))?>,
		name: <? echo json_encode(_("Web orders PLUS"))?>,
		upfrontPrice: 0,
