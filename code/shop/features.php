var features = [
	...
	{
		id: 6,
		description: <? echo json_encode(_("Your own individual web page that allows customers to place orders online.")) ?>,
		...
		subscriptionPrice:20,
		trialPeriod:0,
		descriptionFeatures :[<?echo json_encode(_("Feature1"))?>,
													<?echo json_encode(_("Feature2"))?>,
							],
		contractMonths:3,
	...
	{
		id: 7,
		description: <? echo json_encode(_("Just like ‘Web orders’ but with a customised web address, chosen by you.")) ?>,
