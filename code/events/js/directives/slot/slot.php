<tr ng-repeat='slot in slots track by $index' style='display: none'>
	...
	<td class="eventTDLeadTime">
		<label><?echo _("Lead Time (mins)");?>&nbsp;<i data-tooltip class="icon-question-sign preoTips has-tip tip-bottom" title="<?echo _("The time it takes to prepare your order before the customer can pick up");?>"></i></label>
