<div class="content-modal">
  ...
  <div class="container-modal-confirm" ng-if="!templateUrl" ng-bind-html="toTrusted(content)">    
  </div>

  <div class="container-modal-confirm" id="contentPartial" ng-if="templateUrl"></div>
