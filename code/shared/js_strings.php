...
var Dictionary = { 
	...
	"User selects between":<? echo json_encode(_("User selects between")) ?>,
	"and":<? echo json_encode(_("and")) ?>,
	"or more":<? echo json_encode(_("or more")) ?>,
	"options":<? echo json_encode(_("options")) ?>,
	"User selects":<? echo json_encode(_("User selects")) ?>,
	"Custom choices":<? echo json_encode(_("Custom choices")) ?>,
	...
	"Owner":<? echo json_encode(_("Owner")) ?>,
	...
	"Resend confirmation email?":<? echo json_encode(_("Resend confirmation email?")) ?>,
	"Yes":<? echo json_encode(_("Yes")) ?>,
	"New email has been sent!":<? echo json_encode(_("New email has been sent!")) ?>,
	...
	"Select menu(s) for this outlet":<? echo json_encode(_("Select menu(s) for this outlet")) ?>,
	...
	"Average order value (area)":<? echo json_encode(_("Average order value (area)")) ?>,
	"New":<? echo json_encode(_("New")) ?>,
	"Returning":<? echo json_encode(_("Returning")) ?>,
	"Customers (Pie)":<? echo json_encode(_("Customers (Pie)")) ?>,
	"Total":<? echo json_encode(_("Total")) ?>,
	"Customers (Bar)":<? echo json_encode(_("Customers (Bar)")) ?>,
