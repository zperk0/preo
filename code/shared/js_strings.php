...
var Dictionary = { 
	...
	"Collection Slot: Pre-Show":<? echo json_encode(_("Collection Slot: Pre-Show")) ?>,
	"Collection Slot: Pre-Game":<? echo json_encode(_("Collection Slot: Pre-Game")) ?>,
	"Collection Slot: Interval":<? echo json_encode(_("Collection Slot: Interval")) ?>,
	"Collection Slot: Second-Interval":<? echo json_encode(_("Collection Slot: Second-Interval")) ?>,
	"Collection Slot: Half-time":<? echo json_encode(_("Collection Slot: Half-time")) ?>,
	"Collection Slot: Post-Show":<? echo json_encode(_("Collection Slot: Post-Show")) ?>,
	"Collection Slot: Post-Game":<? echo json_encode(_("Collection Slot: Post-Game")) ?>,
