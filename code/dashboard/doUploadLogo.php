<?php session_start(); //start the session so this file can access $_SESSION vars.
	...
	require_once($_SERVER['DOCUMENT_ROOT'].'/code/shared/uploadFile.php'); //uploadFile functions; params = $fileUploadID, $fileLocation, $fileName, $fileEXT, $fileMIME, $fileMIME2, $maxFileSize, $debug
	...
	$status = uploadFile($picFile,$_SERVER['DOCUMENT_ROOT'].'/img/logoUploads/',$picID, ".$picExt", "image/png", "image/jpeg", 11000000, 0);
	if(!$status) 
	{
		echo "Error :(";
		exit;
