...
<link rel="stylesheet" type="text/css" href="/code/bookingMenus/css/style.css">

  <div ng-app="bookingMenus">
  ...
  <script src="/code/bookingMenus/js/services/bookingSettingsService.js"></script>
  <script src="/code/bookingMenus/js/directives/menus-item/menus-item.js"></script>
  <!-- END WATCH -->

  <script src="/code/bookingMenus/all.min.js"></script>
