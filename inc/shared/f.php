				...
				<footer>
					...
					<div class="custom-inline-list-centered">
						<ul class="custom-inline-list">
							<li><a href="///facebook.com/PreoDay" 	target="_blank" title="Like us on Facebook - facebook.com/PreoDay">Facebook</a></li>
							<li><a href="//twitter.com/PreoDayUK" 	target="_blank" title="Follow us on Twitter - @PreoDayUK">Twitter</a></li>
							<li><a href="mailto:hello@preoday.com" 	target="_blank" title="Click here to contact us">Contact</a></li>
							<li><a href="#" data-reveal-id="termsM"					title="Click here for our Terms &amp; Conditions">Terms</a></li>
							<li><a href="#" data-reveal-id="privM" 					title="Click here for our Privacy Policy">Privacy</a></li>
						</ul>
					</div>
					PreoDay &copy; 2013. All Rights Reserved. 
				</footer>
			</div>
		</div>
	
		<div id="termsM" class="reveal-modal">
			<h2>PreoDay Terms & Conditions</h2>
