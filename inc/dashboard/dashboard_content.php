...
<div class="row row--space1u dashContent">
	...
	<div id="iphone5" class="large-4 columns">
		<div class="venueMode">
		 	<span><?echo _("Change app mode")?> <i data-tooltip class="icon-question-sign preoTips has-tip tip-bottom noPad" title="<?echo _("LIVE - Your app is available and is ready to take real orders.<br/><br/>DEMO - Your app is available but does not take real orders.<br/><br/>OFFLINE - Your app is not available.");?>"></i></span>
