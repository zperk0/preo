				...
				<table class="headerTable">
					<thead>
						<tr>
							...
							<th class="mdTDTPrice hide"><? echo _("Total Price ");?></th>
							<th class="mdTDPrice"><? echo _("Discount Price ");?></th>
						...
						<td class="mdTDIName" colspan="5">
							...
							{ 
								foreach($mdSections as $mdSection) { 
									...
									?>
										<label class="mdItemName sec<?echo $mdSection['id'];?>" style="display:none;"><span id="<?echo $sKey+1?>_item_<?echo $item['id']?>" data-value="<?echo $item['price'];?>">(<?echo number_format($item['price'],2).") ".$item['name'];?></span> &nbsp; <button type="button" class="newmdItem" title="<?echo _("Add this item to the current Meal Deal");?>"><i class="pd-add"></i></button></label>
								<?  }
								}
							}?>
						</td>
					...
					{ 
						foreach($mdSections as $mdSection) { 
							foreach($mdSection['items'] as $item) { 
								if($item['mealDeal']) continue;
							?>
								<label class="mdItemName sec<?echo $mdSection['id'];?>" style="display:none;"><span id="0_item_<?echo $item['id']?>" data-value="<?echo $item['price'];?>">(<?echo number_format($item['price'],2).") ".$item['name'];?></span> &nbsp; <button type="button" class="newmdItem" title="<?echo _("Add this item to the current Meal Deal");?>"><i class="pd-add"></i></button></label>
						<?  }
						}
					}?>
				</td>
