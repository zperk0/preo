			...
			<div class="row">
				<div class="large-12 columns">
						...
						<select id="language" name="language" class="pdDropdown" required tabindex=12>
							...
							<option <?if(isset($_SESSION['venue_language']) && substr($_SESSION['venue_language'], 0, strrpos($_SESSION['venue_language'], '-')) == "sv"){?>selected="selected"<?}?> value="sv">Swedish</option>
							<option <?if(isset($_SESSION['venue_language']) && substr($_SESSION['venue_language'], 0, strrpos($_SESSION['venue_language'], '-')) == "fi"){?>selected="selected"<?}?> value="fi">Finnish</option>
						</select>
