...
..\..\gettext\bin\gettext -n PHP --no-wrap -f %TEMP%\listfile.txt -o new.po
echo Combining old.po and new.po to messages.po
..\..\gettext\bin\msgmerge old.po new.po --output-file=messages.po
echo Converting new messages.po to messages.mo
..\..\gettext\bin\msgfmt -cv messages.po
