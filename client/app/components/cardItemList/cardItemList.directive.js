...
export default function cardItemList(){
  ...
  return {
    ...
    transclude:true,
    require:['cardItemList', '?^^usersList','?^^menuSectionItemList', '?^^menuItemList', '?^^menuSectionList', '?^^modifierList', '?^^outletLocationList', '?^^outletList', '?^^taxGroupList', '?^^deliveryZoneList'],
