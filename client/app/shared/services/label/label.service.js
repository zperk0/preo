export default class LabelService {
  ...
  constructor(gettextCatalog) {
    ...
    this.SNACK_CUSTOMER_SUCCESS_WITH_FAILED_INVITE = gettextCatalog.getString("The customer has been saved, but we had problems to send the email. You can try to send it again editing the customer.");
